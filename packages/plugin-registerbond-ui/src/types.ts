export interface IRegisterbond {
  _id: string;
  name?: string;
  createdAt?: Date;
  expiryDate?: Date;
...
// queries
export type RegisterbondQueryResponse = {
  registerbonds: IRegisterbond[];
  refetch: () => void;
  loading: boolean;
};
export type TypeQueryResponse = {
  registerbondTypes: IType[];
  refetch: () => void;
  loading: boolean;
};
...
// export type RegisterbondMutationVariables = {
//   type: string;
//   targetIds: string[];
//   tagIds: string[];
// };
