...
export default class NotificationService {
    ...
    http:HttpService;
    constructor() {
        this.NOTIFICATION_URL = process.env.NOTIFICATION_URL || 'http://notification.test.rhinos.andsystems.tech';
    ...
    send = async (params) => {
        ...
        let notificationResult = await this.http.request('/v1/notification', data, HttpService.METHOD_POST);
