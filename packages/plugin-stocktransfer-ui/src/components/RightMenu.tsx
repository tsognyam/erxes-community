...
import { STATUS, STOCK } from '../constants';
...
export default class RightMenu extends React.Component<Props, State> {
  ...
  onSearch = (e: React.KeyboardEvent<Element>, type: string) => {
    if (e.key === 'Enter') {
      ...
      if (type === 'stockCompany') {
        data = { stockCompany: target.value || '' };
      }
      if (type === 'stockAccount') {
        data = { stockAccount: target.value || '' };
      }
    ...
    return (
      <FilterBox>
        ...
        <FormControl
          ...
          type="number"
          onKeyPress={e => this.onSearch(e, 'phone')}
        />
        <ControlLabel>{__('Registered Stock Company')}</ControlLabel>
        <FormControl
          defaultValue={queryParams.stockCompany}
          placeholder={__('Enter stockCompany')}
          type="text"
          onKeyPress={e => this.onSearch(e, 'stockCompany')}
        />
        <ControlLabel>{__('Registered Stock Account')}</ControlLabel>
        <FormControl
          defaultValue={queryParams.stockAccount}
          placeholder={__('Enter stockAccount')}
          type="number"
          onKeyPress={e => this.onSearch(e, 'stockAccount')}
        />
